...
describe('UserController (e2e)', function () {
    ...
    it('should /user (GET)  return a list of users', function () {
    ...
    it('should /user (POST) create a new user', function () {
        return request(app.getHttpServer())
            .post('/user')
            .expect(201)
            .send({
    ...
    it('should /user/sign-in (POST) sign-in', function () {
        return request(app.getHttpServer())
            .post('/user/sign-in')
            .expect(201)
            .send({
    ...
    it('should /user (PUT) update user information', function () {
        return request(app.getHttpServer())
            .put('/user')
            .expect(200)
